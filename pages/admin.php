<div class="admin-page">
    ...
    <div class="admin-layout">
        <aside class="admin-sidebar">
            ...
            <nav class="admin-sidebar__nav">
                <a href="#" id="link-stickers" class="admin-sidebar__link active" onclick="openTab('stickers')">
                ...
                <a href="#" id="link-users" class="admin-sidebar__link" onclick="openTab('users')">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="admin-content">
                ...
                <div class="admin-tab active" id="tab-stickers">
                    <div class="admin-page-header">
                        ...
                        <button type="button" class="btn btn--admin" onclick="openModal('modal-sticker')">+ Добавить
                            стикер
                        </button>
                    </div>
                        ...
                        <table class="data-table data-table--responsive">
                            ...
                            <tr>
                                ...
                                <td><span class="data-table__label">Название этапа</span><span
                                            class="data-table__value">Первый день в компании</span>
                                </td>
                    ...
                    <div class="admin-table-actions">
                      <button aria-label="Редактировать"><svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                      ...
                      <button class="delete" aria-label="Удалить"><svg width="16" height="16" viewBox="0 0 24 24"
                            ...
                            <tr>
                                ...
                                <td><span class="data-table__label">Название этапа</span><span
                                            class="data-table__value">Дизайн-Атака</span>
                                </td>
                                <td><span class="data-table__label">Номер этапа</span><span
                    ...
                    <div class="admin-table-actions">
                      ...
                      <button class="delete" aria-label="Удалить"><svg width="16" height="16" viewBox="0 0 24 24"
                            ...
                            <tr>
                                ...
                                <td><span class="data-table__label">Название этапа</span><span
                                            class="data-table__value">SMM-Челлендж</span>
                                </td>
                                <td><span class="data-table__label">Номер этапа</span><span
                    ...
                    <div class="admin-table-actions">
                      ...
                      <button class="delete" aria-label="Удалить"><svg width="16" height="16" viewBox="0 0 24 24"
                            ...
                            <tr>
                                ...
                                <td><span class="data-table__label">Название этапа</span><span
                                            class="data-table__value">Командная защита</span>
                                </td>
                                <td><span class="data-table__label">Номер этапа</span><span
                    ...
                    <div class="admin-table-actions">
                      ...
                      <button class="delete" aria-label="Удалить"><svg width="16" height="16" viewBox="0 0 24 24"
                            ...
                            <tr>
                                ...
                                <td><span class="data-table__label">Название этапа</span><span
                                            class="data-table__value">Вершина мастерства</span>
                                </td>
                                <td><span class="data-table__label">Номер этапа</span><span
                ...
                <div class="admin-tab" id="tab-users">
                    ...
                    <div class="table-wrapper">
                        <table class="data-table data-table--responsive data-table--users">
                            ...
                            <tr>
                                <td><span class="data-table__label">Имя</span><span
                                            class="data-table__value">Елена Козлова</span></td>
                            ...
                            <tr>
                                <td><span class="data-table__label">Имя</span><span
                                            class="data-table__value">Админ Системы</span></td>
    ...
    <div class="modal-overlay" id="modal-sticker" onclick="if (event.target === this) closeModals()">
        <div class="modal" role="dialog" aria-labelledby="modal-title">
            ...
            <h2 class="modal__title" id="modal-title">Добавить стикер</h2>
            <form>
